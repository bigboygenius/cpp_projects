...
С использованием класса *BigInteger* написан класс *Rational* для работы с рациональными числами сколь угодно высокой точности. Числа *Rational* представляются в виде несократимых обыкновенных дробей, где числитель и знаменатель — сколь угодно длинные целые числа. Поддерживаются операции:
